...
/obj/item/clothing/under/sol_peacekeeper
	...
	icon = 'modular_lethal_doppler/armor_but_cool/icons/uniforms.dmi'
	icon_state = "peacekeeper"
	worn_icon = 'modular_lethal_doppler/armor_but_cool/icons/uniforms_worn.dmi'
