...
/obj/item/gun/ballistic/automatic/pistol/weevil
	...
	icon = 'modular_lethal_doppler/paxilguns/icons/guns32x.dmi'
	icon_state = "zomushi"

	rack_sound = 'modular_lethal_doppler/paxilguns/sound/zomushi/zomushi_rack.wav'
	fire_sound = 'modular_lethal_doppler/paxilguns/sound/zomushi/zomushi.wav'
	suppressed_sound = 'modular_lethal_doppler/paxilguns/sound/zomushi/zomushi_silenced.wav'

	pickup_sound = 'modular_lethal_doppler/paxilguns/sound/pickup_sounds/drop_lightgun.wav'
	drop_sound = 'modular_lethal_doppler/paxilguns/sound/pickup_sounds/drop_lightgun.wav'
...
/obj/item/gun/ballistic/automatic/seiba_smg
	...
	load_sound = 'modular_lethal_doppler/paxilguns/sound/seiba/seiba_magin.wav'
	rack_sound = 'modular_lethal_doppler/paxilguns/sound/seiba/seiba_rack.wav'
	fire_sound = 'modular_lethal_doppler/paxilguns/sound/seiba/seiba.wav'
	suppressed_sound = 'modular_lethal_doppler/paxilguns/sound/seiba/seiba_silenced.wav'
	can_suppress = TRUE
