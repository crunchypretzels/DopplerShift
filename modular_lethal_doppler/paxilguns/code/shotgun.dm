...
/obj/item/gun/ballistic/shotgun/ramu
	...
	icon = 'modular_lethal_doppler/paxilguns/icons/guns48x.dmi'
	icon_state = "ramu"

	worn_icon = 'modular_lethal_doppler/paxilguns/icons/mob_sprites/worn.dmi'
	worn_icon_state = "ramu"

	lefthand_file = 'modular_lethal_doppler/paxilguns/icons/mob_sprites/lefthand.dmi'
	righthand_file = 'modular_lethal_doppler/paxilguns/icons/mob_sprites/righthand.dmi'
	...
	load_sound = 'modular_lethal_doppler/paxilguns/sound/ramu/ramu_load.wav'
	fire_sound = 'modular_lethal_doppler/paxilguns/sound/ramu/ramu.wav'
	rack_sound = 'modular_lethal_doppler/paxilguns/sound/ramu/ramu_pump.wav'
	suppressed_sound = 'modular_lethal_doppler/paxilguns/sound/ramu/ramu_silenced.wav'
	can_suppress = TRUE
	can_unsuppress = TRUE
...
/obj/item/gun/ballistic/automatic/nomi_shotgun
	...
	load_sound = 'modular_lethal_doppler/paxilguns/sound/nomi/nomi_magin.ogg'
	rack_sound = 'modular_lethal_doppler/paxilguns/sound/nomi/nomi_rack.wav'
	fire_sound = 'modular_lethal_doppler/paxilguns/sound/nomi/nomi.wav'
