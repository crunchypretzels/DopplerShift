...
/obj/item/gun/ballistic/shotgun/riot/sol
	...
	icon = 'modular_lethal_doppler/paxilguns_prequel/icons/obj/company_and_or_faction_based/carwo_defense_systems/guns48x.dmi'
	icon_state = "renoster"

	worn_icon = 'modular_lethal_doppler/paxilguns_prequel/icons/mob/company_and_or_faction_based/carwo_defense_systems/guns_worn.dmi'
	worn_icon_state = "renoster"

	lefthand_file = 'modular_lethal_doppler/paxilguns_prequel/icons/mob/company_and_or_faction_based/carwo_defense_systems/guns_lefthand.dmi'
	righthand_file = 'modular_lethal_doppler/paxilguns_prequel/icons/mob/company_and_or_faction_based/carwo_defense_systems/guns_righthand.dmi'
	...
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/shotgun_heavy.ogg'
