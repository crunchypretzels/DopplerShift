...
/obj/item/gun/ballistic/automatic/sol_smg
	...
	icon = 'modular_lethal_doppler/paxilguns_prequel/icons/obj/company_and_or_faction_based/carwo_defense_systems/guns32x.dmi'
	icon_state = "sindano"
	...
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/smg_light.ogg'
	can_suppress = TRUE
