...
/obj/item/gun/ballistic/automatic/sol_rifle
	...
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/rifle_heavy.ogg'
	suppressed_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/suppressed_rifle.ogg'
	can_suppress = TRUE
