...
/obj/item/ammo_casing/energy/cybersun_big_kill
	...
	select_name = "Kill"
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/laser_firing/laser.ogg'

/obj/projectile/beam/cybersun_laser
	icon = 'modular_lethal_doppler/paxilguns_prequel/icons/obj/company_and_or_faction_based/saibasan/projectiles.dmi'
...
/obj/item/ammo_casing/energy/cybersun_big_sniper
	...
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/laser_firing/vaporize.ogg'
...
/obj/projectile/beam/cybersun_laser/granata/proc/fuse_activation(atom/target)
	...
	playsound(src, 'modular_lethal_doppler/paxilguns_prequel/sound/grenade_burst.ogg', 50, TRUE, -3)
	qdel(shrapnel_maker)
...
/obj/item/ammo_casing/energy/cybersun_big_shotgun
	...
	variance = 30
	select_name = "Shotgun"
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/laser_firing/melt.ogg'
