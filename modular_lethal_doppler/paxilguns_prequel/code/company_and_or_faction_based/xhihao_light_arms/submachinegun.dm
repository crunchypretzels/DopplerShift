...
/obj/item/gun/ballistic/automatic/xhihao_smg
	...
	icon = 'modular_lethal_doppler/paxilguns_prequel/icons/obj/company_and_or_faction_based/xhihao_light_arms/guns32x.dmi'
	icon_state = "bogseo"

	lefthand_file = 'modular_lethal_doppler/paxilguns_prequel/icons/mob/company_and_or_faction_based/xhihao_light_arms/guns_lefthand.dmi'
	righthand_file = 'modular_lethal_doppler/paxilguns_prequel/icons/mob/company_and_or_faction_based/xhihao_light_arms/guns_righthand.dmi'
	...
	fire_sound = 'modular_lethal_doppler/paxilguns_prequel/sound/smg_heavy.ogg'
	can_suppress = TRUE
