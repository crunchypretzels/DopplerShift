/obj/machinery/door/puzzle/keycard/epic_loot_black
	...
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_black.dmi'
	puzzle_id = "epic_loot_black"

/obj/machinery/door/puzzle/keycard/epic_loot_yellow
	name = "Yellow Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_yellow.dmi'
	puzzle_id = "epic_loot_yellow"

/obj/machinery/door/puzzle/keycard/epic_loot_orange
	name = "Orange Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_orange.dmi'
	puzzle_id = "epic_loot_orange"

/obj/machinery/door/puzzle/keycard/epic_loot_red
	name = "Red Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_red.dmi'
	puzzle_id = "epic_loot_red"

/obj/machinery/door/puzzle/keycard/epic_loot_purple
	name = "Purple Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_ourple.dmi'
	puzzle_id = "epic_loot_purple"

/obj/machinery/door/puzzle/keycard/epic_loot_blue
	name = "Blue Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_blue.dmi'
	puzzle_id = "epic_loot_blue"

/obj/machinery/door/puzzle/keycard/epic_loot_teal
	name = "Teal Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_teal.dmi'
	puzzle_id = "epic_loot_teal"

/obj/machinery/door/puzzle/keycard/epic_loot_green
	name = "Green Airlock"
	desc = "Locked. Looks like you'll need a keycard of matching color to get in."
	icon = 'modular_lethal_doppler/deepmaint_stuff/icons/keycard_doors/door_green.dmi'
