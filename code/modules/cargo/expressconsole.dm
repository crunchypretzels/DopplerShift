...
/obj/machinery/computer/cargo/express/ui_data(mob/user)
	...
	data["printMsg"] = COOLDOWN_FINISHED(src, beacon_print_cooldown) ? "Print Beacon for [BEACON_COST] Libre" : "Print Beacon for [BEACON_COST] Libre ([COOLDOWN_TIMELEFT(src, beacon_print_cooldown)])" //buttontext for printing beacons / DOPPLER EDIT: credits > libre
	data["supplies"] = list()
