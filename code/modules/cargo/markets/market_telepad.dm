...
/obj/machinery/ltsrbt/examine(mob/user)
	...
	if(!(machine_stat & NOPOWER))
		...
		. += span_tinynoticeital("Current market restock price: [EXAMINE_HINT("[restock_cost] ♎︎")].") // DOPPLER EDIT: cr > ♎︎
		. += span_tinynoticeital("Market placement fee: [EXAMINE_HINT("[PLACE_ON_MARKET_COST] ♎︎")].") // DOPPLER EDIT: cr > ♎︎
